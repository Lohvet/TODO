...
<br><div class="container"><br>
        <div class="row">
            ...
            <?php
                ...
                elseif(empty($list)){
                    echo "Type a list to be saved!";
                }
                else{
                
                    $query = "INSERT INTO todolist (Name, DateTime, List) VALUES ('$name', '$datetime', '$list')";
                    ...
                    if((mysqli_errno($connection))){
                        ...
                        echo("Your List is saved successfully!!!");
                    }
                }
            ...
            <br><div class="col-md-12"><br>
                <button><a href="tabledisplay.php">Display My List</a></button>
            </div>
        </div>
    </div>
</body>
